const questions = [
    ...
    },
    {
        ...
        options: ["Joyería y ornamentos", "Baterías para dispositivos electrónicos y vehículos eléctricos", "Fertilizantes agrícolas", "Productos de limpieza"],
        correct: 1
    },
    {
        question: "¿Qué país es uno de los mayores productores de litio a nivel mundial?",
        options: ["Sudáfrica", "Chile", "Australia", "Brasil"],
        correct: 1
    },
    {
    ...
    },
    {
        ...
        options: ["Un proceso de perforación profunda", "Un método para extraer oro utilizando soluciones químicas como el cianuro", "Una técnica de transporte de minerales", "Un proceso de fundición de oro"],
        correct: 1
    },
    {
        question: "¿Cómo se extrae comúnmente el litio de los depósitos de salmuera?",
        options: ["Perforando y extrayendo directamente", "Evaporando el agua para concentrar el litio", "Fundiendo las rocas que lo contienen", "Triturando el mineral en polvo"],
        correct: 1
    },
    {
    ...
    },
    {
        ...
        options: ["Plata", "Potasio", "Plomo", "Hierro"],
        correct: 1
    },
    {
        question: "¿Qué es una batería de iones de litio?",
        options: ["Un tipo de batería desechable", "Una batería recargable que utiliza litio como material principal", "Una batería utilizada solo en vehículos de lujo", "Una batería de uso industrial"],
        correct: 1
    },
    {
    ...
    },
    {
        ...
        options: ["Extracción de oro de depósitos aluviales", "Minería en la que el oro se extrae de rocas sólidas", "Minería en el fondo del mar", "Extracción de oro mediante lixiviación en pilas"],
        correct: 1
    },
    {
