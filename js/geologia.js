const questions = [
    {
        question: "¿Cuál es el nombre del supercontinente que existió hace millones de años?",
        options: ["Gondwana", "Pangea", "Laurasia", "Rodinia"],
        correct: 1
    },
    {
    ...
    },
    {
        ...
        options: ["Roca sedimentaria", "Roca ígnea", "Roca metamórfica", "Roca evaporítica"],
        correct: 1
    },
    {
        question: "¿Cómo se llama el proceso por el cual el agua se infiltra en el suelo y llena los espacios vacíos?",
        options: ["Precipitación", "Infiltración", "Evaporación", "Condensación"],
        correct: 1
    },
    {
        question: "¿Qué tipo de roca está formada por la acumulación de sedimentos?",
        options: ["Roca ígnea", "Roca sedimentaria", "Roca metamórfica", "Roca volcánica"],
        correct: 1
    },
    {
    ...
    },
    {
        ...
        options: ["Una piedra preciosa", "Un mineral", "Restos preservados de organismos antiguos", "Un tipo de roca"],
        correct: 2
    },
    {
    ...
    {
        question: "¿Qué fenómeno natural ocurre cuando la energía almacenada en la Tierra se libera repentinamente?",
    ...
    },
    {
        ...
        options: ["Un volcán que ha hecho erupción recientemente", "Un volcán que no ha hecho erupción en mucho tiempo, pero podría hacerlo", "Un volcán en erupción constante", "Un volcán sumergido en el océano"],
        correct: 1
    },
    {
        question: "¿Qué son las placas tectónicas?",
        options: ["Grandes bloques de hielo flotante", "Capas de roca en movimiento en la superficie terrestre", "Fragmentos de cometas que caen a la Tierra", "Montañas formadas por el viento"],
        correct: 1
    },
    {
        question: "¿Qué gas es el principal responsable de la formación de ácido en la lluvia ácida?",
        options: ["Oxígeno", "Dióxido de carbono", "Dióxido de azufre", "Metano"],
        correct: 2
    },
    {
        question: "¿Cómo se llama la roca que se forma cuando la lava se enfría y solidifica rápidamente?",
