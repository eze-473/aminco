const questions = [
  ...
  {
    question: "¿Qué es la minería artesanal y de pequeña escala (MAPE)?",
    options: [
  ...
  {
    question: "¿Qué significa realizar una compensación ambiental en minería?",
    options: [
  ...
  {
    question:
      "¿Cómo pueden las empresas mineras contribuir a la conservación de la biodiversidad?",
    options: [
  ...
  {
    question:
      "¿Por qué es fundamental el diálogo con las comunidades indígenas en proyectos mineros?",
    options: [
  ...
  {
    question: "¿Qué significa el término 'minería inclusiva'?",
    options: [
  ...
  {
    question: "¿Qué es la minería responsable con el agua?",
    options: [
